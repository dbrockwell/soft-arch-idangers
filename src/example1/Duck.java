 ...
 * However, the Duck author chose to send the "quack" message to the console, even
 * though it is clear by examining the Animal class that the original author
 * intended the output to be in a GUI.
 *
