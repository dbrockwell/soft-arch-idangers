 ...
 * consistently needs to be maintained, you are going to have a problem. Also,
 * notice that in the Animal class version of speak(), a JOptionPane is used to
 * display what is spoken. But in the overridden versions (see Duck and Dog) the
 * console is used. Does it matter? It might, depending on the type of GUI you
 * might be using.
 * <p>
