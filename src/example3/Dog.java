...
public abstract class Dog {
     ...
     * the dog feels and behaves. A 15-year-old (real years) dog will feel like
     * and exhibit behaviors of a 75-year old (e.g., arthritis, less stamina and
     * muscle, etc.)
     *
     * @return the adjusted age of the dog. BUT NOTICE THAT THE AUTHOR OF THIS
