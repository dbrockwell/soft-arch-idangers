 ...
 * the author recognized that Duck objects should quack, so to be able to
 * provide that behavior, the author chose to override the speak() method.
 ...
 * output to be in a GUI. Is the Duck author's override of speak() acceptable?
 * It depends. Unfortunately the Animal author didn't document his/her
 * intentions, so we'll never know until it's too late. What if someone else
 * wants to reuse the Duck class, but in a GUI based program? What will they
 * have to do?
 * <p>
